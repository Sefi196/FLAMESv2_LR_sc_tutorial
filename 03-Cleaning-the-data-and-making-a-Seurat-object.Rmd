---
title: "Removing sources of unwanted noise from the single cell dataset"
author: "Sefi Prawer"
date: "`r Sys.Date()`"
...
```{r perform_empty_drops_analysis, echo=TRUE, message=FALSE, warning=FALSE}
...
run_decontX <- function(seurat_obj_path, background_counts_path, sample_id) {
  ...
  contamination_umap <- FeaturePlot(
    ...
    reduction = "umap"
  ) + labs(title = "UMAP Colored by decontX contamination value")
