...
```{r perform_empty_drops_analysis, echo=TRUE, message=FALSE, warning=FALSE, cache=TRUE}
...
![Barcode rank plot produced by FLAMES.](images/knee_plot.png){width="600"}

```{r decontX, echo=TRUE, cache=TRUE}
