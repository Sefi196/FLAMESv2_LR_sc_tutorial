...
csl: apa.csl  # Citation style (APA in this case)
link-citations: yes  # Optional: clickable citations in HTML output
---
...
and that you have run FLAMES to calculate the ambient RNA profile. An explanation of how to this can be found here: ... [placeholder]
...
This single sample tutorial will use data generated in the Clark lab from the University of Melbourne. This is small dataset of approximately 400 cells. The cells are at Day55 of a excitatory neural differentiation protocol. More information on the dataset and sequencing methodology and differentiation protocal can be found in this publication [@you2023a]

If you find this tutorial useful please cite our work **[PLACE HOLDER]**

If you have questions or suggestions please email [sefi.prawer\@unimelb.edu.au](mailto:sefi.prawer@unimelb.edu.au){.email} or leave a comment on this github page <https://github.com/Sefi196/FLAMESv2_LR_sc_tutorial>.
