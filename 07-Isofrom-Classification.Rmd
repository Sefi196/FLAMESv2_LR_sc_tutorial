...
```{r SQANTI_plots, include=TRUE, echo=TRUE, warning=FALSE, fig.height=10, fig.width=14}
...
```{r uniq_isofrom, include=TRUE, echo=TRUE, warning=FALSE, fig.height=6, fig.width=8}
...
```{r Glut_specific, include=TRUE, echo=TRUE, warning=FALSE, fig.height=8, fig.width=12}
...
```{r ORFS-plot3,include=TRUE, echo=TRUE, warning=FALSE, fig.height=6, fig.width=12}
library(ORFik)
