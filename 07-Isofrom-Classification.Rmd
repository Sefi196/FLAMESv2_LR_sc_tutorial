...
```{r IsoVis-plot2, fig.cap="IsoVis visualization of Novel OAZ2 isoform.", out.width="1000px"}
...
```{r IsoVis-plot-zoom, fig.cap="IsoVis visualization of exon 2 of OAZ2.", out.width="1000px"}
...
```{r IsoVis-plot3, fig.cap="IsoVis visualization of Novel ZMAT5 isoform.", out.width="1000px"}
