...
```{r traj_fucntion, echo=TRUE, include=TRUE}
    ...
    perform_trajectory_analysis <- function(seurat_obj, assay, prefix, cluster_name="harm_cluster", 
      ...
      # Another plot for top 16 features DE across pseudotime 
