...
# Install packages if required. Note some packages require installation via Bioconductor. See installation instructions for each package to ensure installation is successful.
...
First let's define a helper function for this step:
...
Like before, let's define a generic helper function first to do this:
