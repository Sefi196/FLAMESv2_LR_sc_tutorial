...
2.  That you have run FLAMES to calculate the ambient RNA profile. An explanation of how to this can be found here: ... [placeholder]
...
```{r load_libs, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
#install packages if required. Note packages require installation via bioconductor. see installation instruction for each package to ensure installation is unsuccessful. 
library(rtracklayer)
library(Seurat)
...
```{r convert_ENSGID_to_geneSymbol_exec, echo=TRUE}
