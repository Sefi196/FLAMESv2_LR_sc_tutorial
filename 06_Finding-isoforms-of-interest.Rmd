...
```{r vln MACF1, include=TRUE, echo=TRUE, warning=FALSE, fig.height=10, fig.width=10 }
...
```{r isoviz-plot, fig.cap="IsoViz visualization of 4 MACF1 isoforms.", out.width="1600px"}
